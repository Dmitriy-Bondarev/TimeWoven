...
- (2026-04-30) **Git (T-P2-008)**: merged `origin/main` into `develop` to unblock `develop → main` (PR #26); resolved conflicts in `Makefile`, `app/api/routes/deploy.py`, and `docs/project/CHANGELOG.md`.
- (2026-04-30) **Git (T-P2-009)**: repair `develop` ancestry vs `main` after PR #27 was squash-merged (`main` was not an ancestor → PR #26 stayed dirty): true merge-commit of `origin/main` into `develop` to restore lineage; same conflict resolutions as T-P2-008.
