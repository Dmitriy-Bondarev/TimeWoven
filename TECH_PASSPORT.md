...
- **Текущее состояние:** основная семейная лента опирается на **воспоминания** (`Memories` — текст, пересказ, суть `essence_text` и т.д.) и существующие правила публикации/аудитории.
